...
Bảng \hyperref[tab:tab2]{2.2} bên dưới mô tả các kết quả thực nghiệm của chúng tôi với các độ đo \(H@K\) trên tập validation khi thêm toàn bộ phần tử trong tập test vào mô hình đã train trong bước trên. Chúng tôi hiện tại chưa tìm được phương pháp đánh giá hợp lý cho chiến lược online-to-online nên phần này chúng tôi để lại cho các nghiên cứu sau này tạm thời chúng tôi chỉ đánh giá chiến lược offline-to-online.
