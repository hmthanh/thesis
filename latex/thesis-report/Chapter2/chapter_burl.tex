...
Bảng \hyperref[tab:tab2]{2.2} bên dưới mô tả các kết quả thực nghiệm của chúng tôi với các độ đo \(H@K\) trên tập validation khi thêm toàn bộ phần tử trong tập test vào mô hình đã train trong bước trên. Đối với chiến lược online-to-online chúng tôi nhận thấy khó đánh giá trên tập validation nên chúng dôi đánh giá dựa trên số luật trung bình được sinh ra thi thêm một luật vào và đánh giá độ chính xác một lần khi thêm tất cả các phần tử trong tập huấn luyện.
