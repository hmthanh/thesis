...
Bảng \hyperref[tab:tab2]{2.2} bên dưới mô tả các kết quả thực nghiệm của chúng tôi với hai chiến lược thêm tri thức mới vào đồ thị. Chúng tôi đánh giá trên hai phương diện là tổng số luật được sinh ra, các luật có độ tin cậy \(>= 80\%\) và \(>= 50\%\). Thứ các độ đo \(H@K\) trên tập validation khi thêm toàn bộ phần tử trong tập test vào mô hình đã train trong bước trên.
