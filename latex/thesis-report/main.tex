...
%\include{Appendix/reassurances}s
...
\printbibliography[heading=subbibliography, title={Phương pháp AnyBURL}, keyword=AnyBURL, resetnumbers=2]


\printbibliography[heading=subbibliography, title={Phương pháp CGAT}, keyword=CGAT, resetnumbers=3]
