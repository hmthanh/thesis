...
Về phương pháp dựa trên nhúng đồ thị chúng tôi sẽ trình bày lại về cơ chế chú ý (attention mechanisms), cách cơ chế chú ý được áp dụng vào đồ thị tri thức bằng mô hình GAT và mô hình KBAT %cũng như cải tiến của chúng tôi trên đồ thị dưa trên cải tiến mới nhất của cơ chế chú ý.
